...
NOTE: Los volúmenes aumentan de tamaño automáticamente cuando se supera el umbral de utilización definido. Los volúmenes nunca se reducen automáticamente.
...
| `trident.netapp.io/autogrowPolicy: standard-agp` | No establecido | Usos `standard-agp`. 
