...
La anotación de PVC siempre tiene prioridad. Si un PVC tiene la  `trident.netapp.io/autogrowPolicy` anotación, Trident usa ese valor sin importar lo que especifique StorageClass. Consulta link:automatic-volume-expansion.html#policy-precedence["Precedencia de políticas"] para más detalles.
