...
Para configurar el almacenamiento en bloque (iSCSI), consulta link:gcnv-block.html["Configura el almacenamiento en bloque (iSCSI)"].
...
NOTE: Para los grupos de almacenamiento UNIFIED de Google Cloud NetApp Volumes, Trident aplica reglas de nomenclatura y validación específicas de UNIFIED durante las operaciones de volumen.
