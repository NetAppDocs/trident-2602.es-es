...
summary: Conoce más sobre los puertos por los que se comunica Trident. 
---
= Puertos de Trident
:hardbreaks:
:allow-uri-read: 
...
NOTE: El puerto de la sonda de actividad/preparación se puede cambiar durante la instalación usando la  `--probe-port` bandera. Es importante asegurarte de que este puerto no esté siendo usado por otro proceso en los nodos de trabajo.
